...
"""
        ...
        assert (
            html
            == "<div><h1>Heading 1</h1><p>This is <b>bolded</b> paragraph text in a p tag here</p><h2>Heading 2</h2><p>This is another paragraph with <i>italic</i> text and <code>code</code> here</p></div>"
        )
...
- third
        ...
        node = markdown_to_html_node(md)
        html = node.to_html()
        assert html == "<div><ul><li>first</li><li>second</li><li>third</li></ul></div>"
